package arun.com.chromer.util.glide.glide;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof arun.com.chromer.util.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new arun.com.chromer.util.glide.GlideOptions().apply(toSet));
    }
  }
}
