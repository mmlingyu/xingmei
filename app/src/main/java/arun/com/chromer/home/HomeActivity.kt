...
class HomeActivity : BaseActivity(), Snackable {
    ...
    override fun getLayoutRes(): Int {
        return R.layout.bactivity_main
    }
    ...
    private fun setupToolbar() {
        GlideApp.with(this).load(R.drawable.ic_add).into(backdrop)
        ...
        with(DrawerBuilder()) {
            ...
            withAccountHeader(
                    with(AccountHeaderBuilder()) {
                        withActivity(this@HomeActivity)
                        withHeaderBackground(R.drawable.spot_dection_off)
            ...
            addDrawerItems(
                    PrimaryDrawerItem()
                            .withName(getString(R.string.save_time))
                            .withIdentifier(4)
                            .withIcon(CommunityMaterial.Icon.cmd_clipboard_text)
                            .withSelectable(false),
                    PrimaryDrawerItem()
                            .withName(getString(R.string.default_clear_msg))
                            .withIdentifier(2)
                            .withIcon(CommunityMaterial.Icon.cmd_message_text)
                            .withSelectable(false),
                    PrimaryDrawerItem()
                            .withName(getString(R.string.search_menu_title))
                            .withIdentifier(3)
                    ...
                    SecondaryDrawerItem()
                            ...
                            .withDescription(getString(R.string.save_time))
                            .withIdentifier(7)
                            .withSelectable(false),
                    SecondaryDrawerItem()
            ...
            withOnDrawerItemClickListener { _, _, drawerItem ->
                ...
                when (i) {
                    ...
                    7 -> {
                        ...
                        shareIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.save_time))
                        shareIntent.type = "text/plain"
                        startActivity(Intent.createChooser(shareIntent, getString(R.string.save_size_dialog_content)))
                    }
                    8 -> startActivity(Intent(this@HomeActivity, DonateActivity::class.java))
