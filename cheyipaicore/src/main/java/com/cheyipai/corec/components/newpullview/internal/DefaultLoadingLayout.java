...
public abstract class DefaultLoadingLayout extends LoadingLayout {
    ...
    public DefaultLoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
        super(context);
        mMode = mode;
