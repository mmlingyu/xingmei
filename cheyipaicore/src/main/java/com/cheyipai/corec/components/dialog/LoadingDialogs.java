...
public class LoadingDialogs extends Dialog {
    ...
    * */
    ...
    private void initView(View contentView) {
        loadingProgressImage = (ImageView) contentView.findViewById(R.id.iv_loading_progress);
        loadingProgressImage.setBackgroundDrawable(new LoadingDrawable(context));
        ivLoadingError = (ImageView) contentView.findViewById(R.id.iv_loading_error);
        ivLoadingSuccess = (ImageView) contentView.findViewById(R.id.iv_loading_success);
    ...
    * */
    public void loadingError(String status) {
        loadingProgressImage.setVisibility(View.GONE);
        ivLoadingSuccess.setVisibility(View.GONE);
        ivLoadingError.setVisibility(View.VISIBLE);
   ...
   * */
    public void loadingSuccess(String status) {
        loadingProgressImage.setVisibility(View.GONE);
        ivLoadingError.setVisibility(View.GONE);
        ivLoadingSuccess.setVisibility(View.VISIBLE);
        tvLoadingStatus.setText(status);
    }
