    ...
    public ImageListener getImageListener(final ImageView view,
        ...
        return new ImageListener() {
            ...
            public void onResponse(ImageContainer response, boolean isImmediate) {
                if (response.getBitmap() != null && !TextUtils.isEmpty(view.getTag()+"")&& view.getTag().equals(response.getRequestUrl())) {
                    view.setImageBitmap(response.getBitmap());
//                    JCDrwable.setBitmap(view, MyApplication.getInstance(), response.getBitmap());
    ...
    public ImageListener getImageListener(final ImageView view,
                                                 final int defaultImageResId, final int errorImageResId, final ICallBack callback) {
        return new ImageListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                if (errorImageResId != 0 && view != null) {
                    view.setImageResource(errorImageResId);
                    callback.onError();
                }
            }
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        // track it.
        Request<?> newRequest =
                new RequestImageXmlUtil(requestUrl, new Listener<Bitmap>() {
                    @Override
